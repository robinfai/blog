...
type CommentsConfig =
  | {
      enabled: true;
      provider: "giscus";
      /** GitHub repository for comments, e.g. "owner/repo" */
      repo: string;
      /** giscus repository id, generated by https://giscus.app/ */
      repoId: string;
      /** GitHub Discussions category name */
      category: string;
      /** giscus discussion category id, generated by https://giscus.app/ */
      categoryId: string;
      /** How a page maps to a Discussion. Defaults to "pathname". */
      mapping?: GiscusMapping;
      /** Required when mapping is "specific"; ignored otherwise. */
      term?: string;
      /** Search Discussions strictly by the selected mapping. Defaults to true. */
      strict?: boolean;
      /** Show reactions above comments. Defaults to true. */
      reactionsEnabled?: boolean;
      /** Emit discussion metadata events. Defaults to false. */
      emitMetadata?: boolean;
      /** Where to place the comment input. Defaults to "bottom". */
      inputPosition?: GiscusInputPosition;
      /** giscus theme name. "auto" follows this site's current theme. */
      theme?: "auto" | string;
      /** giscus UI language. Defaults to the site language. */
      lang?: string;
      /** Load comments lazily. Defaults to "lazy". */
      loading?: "lazy" | "eager";
    }
  | { enabled: false };
...
interface FeaturesConfig {
  ...
  /** Comments shown on post detail pages. */
